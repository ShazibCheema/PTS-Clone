...
<nav class="navbar navbar-expand-md bg-body py-3">
    ...
    <div class="container justify-content-center align-items-center mt-5 mb-5">
        <div class="row">
            <div class="col-md-6">
                <h5 class="text-primary">Ability Assessment Test (AAT)</h5>
                <p>AAT is designed to assess the ability ot students for admissions in universities I institutions. After
                    passing this test, student will be eligible for admission in universities / institutions in the specific
                    course. The students will be applied for admission after announcements and will present TAG result
                    card.</p>
