...
<nav class="navbar navbar-expand-md bg-body py-3">
    ...
    <div class="container justify-content-center align-items-center mt-5 mb-5">
        <div class="row">
            <div class="col-md-6">
                <h5 class="text-primary">Test For Assessment Of Graduates (TAG)</h5>
                <p>TAG iS designed for admissions in the M.Phill M.S Programs. The student Will be given admission in
                    M.S 1' M.Phill Program if he qualified TAG result.</p>
